          ...
          <ScrollView>
            ...
            ><Entypo name="dot-single" size={20} color="black" />Go inside but stay alert</Text>
             <Text
              ...
              >
                <Entypo name="dot-single" size={20} color="black" />Shelter in a room on the opposite side of the house from the approaching fire and one that has a clear exit out of the house</Text>
              <Text
                style={{
                  paddingBottom: 10
                }}
              ...
              <Text><Entypo name="dot-single" size={20} color="black" />Protect yourself from the heat of the fire </Text>
    </ScrollView>
    </View>
            {/* <Text
            style={{
